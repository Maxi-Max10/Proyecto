...
public class Ahorcado {
	...
	public static final String[] vPalabrasSecretas=
			{ "cámara", "teclado", "monitor", "mesa", "pizarra", "profesor", "proyector", "abrigo", "teléfono", "terminal",
			  "pantalla", "ratón", "ordenador", "silla", "encerado", "alumno", "aula", "mochila", "invitado", "editor","flopi" };
	
	// Vector de índices de palabra con las que ya hemos jugado para evitar repeticiones
	...
	// Devuelve una palabra aleatoria del vector de palabras secretas con la que aun no se haya jugado
	...
	// La partida devuelve TRUE si el jugador obtiene una victoria, FALSE si ha sido derrotado
